...
const records = {
  "/body-type-styling/how-to-look-taller-clothing": {
    ...
    visual: {
      variant: "comparison",
      src: "/seo/body-type/how-to-look-taller-clothing.webp",
      fallbackSrc: "/seo/oversized-vs-intentional-silhouette.webp",
      fallbackIsComposed: true,
  ...
  "/body-type-styling/apple-body-shape-india": {
    ...
    visual: {
      variant: "comparison",
      src: "/seo/body-type/apple-body-shape-india.webp",
      alt: "The same fictional apple-shaped Indian woman in a boxy gathered outfit and a structured vertical-line outfit, preserving the same body and identity",
      width: 1600,
      height: 2000,
      title: "Structure Creates Direction",
      labels: ["Volume Without Direction", "Intentional Vertical Line"],
    },
    growth: {
