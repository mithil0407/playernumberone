...
const NAV = [{ href: '/globe/admin/dashboard', label: 'Submissions', icon: LayoutDashboard }];

export default function GlobeAdminShell({ children }: { children: React.ReactNode }) {
  ...
  const handleLogout = async () => {
    ...
    router.push('/globe/admin/login');
    router.refresh();
  };

  if (pathname === '/globe/admin/login') return <>{children}</>;
