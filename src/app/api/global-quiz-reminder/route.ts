...
async function handleReminder(request: NextRequest) {
    ...
    try {
        ...
        // ── Find paid globe orders (USD/Global) in the 30–90 min window ─────
        ...
        for (const order of orders) {
            ...
            const intakeLink = `https://www.iconik.pro/global/intake?email=${encodeURIComponent(email)}&phone=${encodeURIComponent(phone)}`;
