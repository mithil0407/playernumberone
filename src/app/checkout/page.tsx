      ...
      <div className="max-w-4xl mx-auto px-4 py-4 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            ...
            {/* Alternative: Free WhatsApp Consultation */}
            <div className="bg-luxury-pink-bg/40 backdrop-blur-sm border border-luxury-accent/20 rounded-xl p-4 text-center hover:bg-luxury-pink-bg/60 transition-all duration-300">
              <a
              ...
              >
                <div className="flex items-center justify-center gap-2 mb-1">
                  <div className="flex-shrink-0 w-5 h-5 bg-[#25D366] rounded-full flex items-center justify-center">
                  ...
                  <p className="luxury-body text-luxury-charcoal/80 text-xs md:text-sm">
                    🤔 Not sure? <span className="text-luxury-accent font-semibold">Try Free WhatsApp Advice</span>
                  </p>
                </div>
              </a>
            </div>
