...
export default function MenCheckoutPage() {
  ...
  useEffect(() => {
    trackPageView('Men Checkout');
    trackViewContent(
      'ICONIK Men Style Blueprint - Checkout',
      discountedPrice,
      ['iconik_men_style_blueprint'],
      'INR',
      'India'
    );
  }, [discountedPrice]);
  ...
  // Preload Razorpay script immediately on page load
  useEffect(() => {
  ...
  const processPayment = useCallback(async () => {
    ...
    trackInitiateCheckout(totalAmount, itemCount, 'ICONIK Men Style Blueprint', 'INR', 'India');
    ...
    try {
      const orderData = {
        ...
        amount: totalAmount,
        base_product: 'Iconik Men Style Blueprint',
        add_ons: {
      ...
      const initializeRazorpay = () => {
        const options = {
          ...
          handler: function (response: RazorpayResponse) {
            const purchasedItems = ['iconik_men_style_blueprint'];
            ...
            trackPurchase(totalAmount, 'ICONIK Men Complete Package', purchasedItems, purchasedItems.length, 'INR', 'India', response.razorpay_payment_id);
    ...
    <div className="min-h-screen bg-luxury-warm-white text-luxury-charcoal">
      ...
      <header className="bg-luxury-warm-white/95 backdrop-blur-xl border-b border-luxury-cream sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <Link href="/men" className="flex items-center gap-2 text-luxury-accent hover:text-luxury-charcoal transition-colors luxury-body">
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            <h2 className="text-2xl md:text-3xl luxury-heading text-luxury-charcoal mb-6 text-center">Get Your Men&apos;s Blueprint</h2>
            ...
            <div className="bg-luxury-warm-white border-2 border-luxury-charcoal text-luxury-charcoal rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm md:text-base luxury-body text-luxury-charcoal/70 mb-3">
                  Delivered 1-on-1 by Certified Style & Image Consultants
                </p>
              ...
              <div className="mb-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2 md:gap-3">
                    ...
                    <span className="luxury-body text-luxury-charcoal/80 text-sm md:text-base">Geometric Frame Profile™ — fits built for your body</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3">
                    <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-luxury-accent flex-shrink-0 mt-0.5" />
                    <span className="luxury-body text-luxury-charcoal/80 text-sm md:text-base">Personal Colour Palette — 10 that work, 4 to cut</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3">
                    <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-luxury-accent flex-shrink-0 mt-0.5" />
                    <span className="luxury-body text-luxury-charcoal/80 text-sm md:text-base">Facial Architecture Analysis™ — collar, eyewear, hair</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3">
                    <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-luxury-accent flex-shrink-0 mt-0.5" />
                    <span className="luxury-body text-luxury-charcoal/80 text-sm md:text-base">Grooming & Hair Blueprint</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3">
                    <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-luxury-accent flex-shrink-0 mt-0.5" />
                    <span className="luxury-body text-luxury-charcoal/80 text-sm md:text-base">30-min Private 1-on-1 Stylist Call</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3">
                    <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-luxury-accent flex-shrink-0 mt-0.5" />
                    <span className="luxury-body text-luxury-charcoal/80 text-sm md:text-base">16 Complete Outfit Formulas — office, casual, occasion</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <h4 className="luxury-heading text-luxury-charcoal text-base">🗂️ Wardrobe Detox</h4>
                        <span className="text-luxury-green font-semibold text-lg flex-shrink-0">₹{wardrobeDetoxPrice}</span>
                      </div>
                      <p className="text-xs luxury-body text-luxury-charcoal/70 mb-2">
                        We audit your current wardrobe and build a tight, intentional closet
                      </p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="text-[10px] bg-luxury-cream px-2 py-0.5 rounded-full text-luxury-charcoal/70">Closet audit</span>
                        <span className="text-[10px] bg-luxury-cream px-2 py-0.5 rounded-full text-luxury-charcoal/70">Keep/cut guide</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs luxury-body text-luxury-charcoal/70 mb-2">
                        Curated brand guide for your frame type + budget
                      </p>
                      <div className="flex flex-wrap gap-1.5">
                        <span className="text-[10px] bg-luxury-cream px-2 py-0.5 rounded-full text-luxury-charcoal/70">Best menswear brands for you</span>
                        ...
                        <span className="text-[10px] bg-luxury-cream px-2 py-0.5 rounded-full text-luxury-charcoal/70">Colour-matched picks</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-luxury-cream/40 backdrop-blur-xl rounded-3xl p-5 md:p-6 border border-luxury-cream">
              <div className="space-y-2 mb-4">
                <div className="flex justify-between items-center text-sm luxury-body text-luxury-charcoal/70">
                  <span>Men&apos;s Style Blueprint</span>
              ...
              <button
                ...
                onClick={async (e) => {
                  ...
                  if (!hasAddons && !popupDismissed) {
                    setShowAddonPopup(true);
                    trackCTAClick('Add-on Popup Shown', 'Men Checkout Main Button', totalAmount, 'INR', 'India');
                  } else {
                    await processPayment();
                  }
                }}
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-5 md:p-6 shadow-lg border border-white/20">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-600 font-light font-['Inter',sans-serif]">
                  ...
                  <span>Blueprint delivered within 24 hours</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-gray-600 font-light font-['Inter',sans-serif]">
          ...
          >
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1">
                  ...
                  <p className="text-xs md:text-sm luxury-body text-luxury-charcoal/70">
                    Add these to get the full package
                  </p>
                </div>
                <button
                  onClick={() => {
                    ...
                    trackCTAClick('Add-on Popup Dismissed', 'Men Popup Close Button', undefined, 'INR', 'India');
                  }}
            ...
            <div className="p-3 md:p-4 space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      <h4 className="luxury-heading text-luxury-charcoal text-sm md:text-base">🗂️ Wardrobe Detox</h4>
                      <span className="text-luxury-green font-semibold text-base flex-shrink-0">₹{wardrobeDetoxPrice}</span>
                    </div>
                    <p className="text-xs luxury-body text-luxury-charcoal/70 mb-2">
                      We audit your closet and build a tight, intentional wardrobe
                    </p>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      <h4 className="luxury-heading text-luxury-charcoal text-sm md:text-base">🛍️ Smart Shopper&apos;s Guide</h4>
                      <span className="text-luxury-green font-semibold text-base flex-shrink-0">₹{smartShoppersGuidePrice}</span>
                    </div>
                    <p className="text-xs luxury-body text-luxury-charcoal/70 mb-2">
                      Curated brand guide for your frame type + budget
                    </p>
                    <div className="space-y-1">
                      <div className="flex items-start gap-1.5 text-xs luxury-body text-luxury-charcoal/70">
                        <CheckCircle className="w-3.5 h-3.5 text-luxury-accent flex-shrink-0 mt-0.5" />
                        <span>Best menswear brands for your frame</span>
                      </div>
                      <div className="flex items-start gap-1.5 text-xs luxury-body text-luxury-charcoal/70">
                        <CheckCircle className="w-3.5 h-3.5 text-luxury-accent flex-shrink-0 mt-0.5" />
                      ...
                      <div className="flex items-start gap-1.5 text-xs luxury-body text-luxury-charcoal/70">
                        <CheckCircle className="w-3.5 h-3.5 text-luxury-accent flex-shrink-0 mt-0.5" />
                        <span>Sizing by brand</span>
                      </div>
                      <div className="flex items-start gap-1.5 text-xs luxury-body text-luxury-charcoal/70">
                        <CheckCircle className="w-3.5 h-3.5 text-luxury-accent flex-shrink-0 mt-0.5" />
                        <span>Colour-matched picks for your palette</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="sticky bottom-0 bg-luxury-warm-white/95 backdrop-blur-xl border-t border-luxury-cream p-3 md:p-4 space-y-2">
              <button
                onClick={async () => {
                  setShowAddonPopup(false);
                  trackCTAClick('Proceed with Add-ons', 'Men Popup Continue Button', totalAmount, 'INR', 'India');
                  await processPayment();
                }}
                disabled={isProcessing}
              ...
              <button
                onClick={() => {
                  trackCTAClick('Continue without Add-ons', 'Men Popup Skip Button', totalAmount, 'INR', 'India');
