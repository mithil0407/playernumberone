...
export const metadata: Metadata = {
  ...
  description: "Online personal styling for Chandigarh women. Iconik's science-backed Style Blueprint — body analysis, colour palette, and 20 outfit formulas for Chandigarh's style-forward professional lifestyle. Delivered within 5 working days after consultation.",
  ...
  openGraph: {
    title: "Personal Stylist in Chandigarh — Iconik Style Blueprint",
    description: "Science-backed personal styling for Chandigarh women. Blueprint delivered within 5 working days after consultation.",
