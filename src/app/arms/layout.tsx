...
export const metadata: Metadata = {
  ...
  description: "Science-backed sleeve and cut guide for Indian women with heavier arms. Learn exactly which silhouettes, sleeve lengths, and fabrics minimise arm width while maximising elegance. 16-outfit Blueprint delivered in 48 hours.",
