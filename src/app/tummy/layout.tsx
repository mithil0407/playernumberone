...
export const metadata: Metadata = {
  ...
  description: "Practical, science-backed guide to dressing a fuller midsection. Discover which cuts, fabrics, and draping techniques create a defined waist — without shapewear. Personalised Blueprint within 5 working days after the consultation.",
  ...
  openGraph: {
    ...
    description: "Science-backed cuts and draping to create a defined waist. Personalised Blueprint within 5 working days after the consultation.",
