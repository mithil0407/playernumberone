...
export const metadata: Metadata = {
  ...
  description: "A science-backed plus-size fashion guide built specifically for Indian women. Discover silhouettes, colours, and cuts that celebrate your frame — not hide it. Personalised Blueprint in 48 hours.",
  ...
  openGraph: {
    title: "Plus Size Styling Guide for Indian Women — Iconik",
    description: "Science-backed silhouettes, colours, and cuts for plus-size Indian women. Personalised Blueprint in 48 hours.",
