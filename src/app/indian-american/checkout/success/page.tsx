...
function SuccessPageContent() {
    ...
    useEffect(() => {
        // Track page view for Indian-American funnel
        ...
        if (purchaseAmount) {
            ...
            console.warn('⚠️ No purchaseAmount found in localStorage');
        }
        ...
        // Log what we found
        console.log('🎯 Indian-American Success Page - URL Parameters:', {
            customerId,
            orderId,
            dbOrderId,
            paymentId,
                    ...
                    <div className="space-y-5 text-left">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm">Get ready for your custom style transformation roadmap tailored for Indian-American women</p>
                            </div>
                        </div>
                    </div>
                </div>
