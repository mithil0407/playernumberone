          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center">
                <span className="text-3xl luxury-heading text-luxury-charcoal tracking-wider">ICONIK CLOSET</span>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
              ...
              <div className="md:col-span-2">
                <div className="text-3xl luxury-heading text-luxury-charcoal mb-6">ICONIK CLOSET</div>
            ...
            <div className="border-t border-luxury-cream pt-8 text-center">
              <p className="luxury-body text-luxury-charcoal/60">
                © 2024 PlayerNumberOne ICONIK CLOSET. All rights reserved.
              </p>
        ...
        {showDoubtClearingPopup && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
            ...
            >
              ...
              <a
                href="https://api.whatsapp.com/send/?phone=919130048899&text=Hi+ICONIK%21+I%27m+interested+in+Iconik+Closet+subscription+but+have+some+doubts.+Can+you+help+me%3F&type=phone_number&app_absent=0"
                target="_blank"
