              ...
              <div className="space-y-8">
                <Link
                  ...
                  onClick={() => {
                    ...
                    trackCTAClick('Final CTA', 'Bottom Section', 1999, 'INR', 'India');
                  }}
                ...
                <p className="luxury-body opacity-75 text-center">₹1,999 + GST • Limited slots available</p>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-luxury-warm-white/98 backdrop-blur-xl border-t border-luxury-cream p-3 md:hidden z-50">
          <div className="max-w-sm mx-auto">
            <div className="flex items-center justify-between mb-3">
              <div className="flex-1">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-base font-semibold text-luxury-green">₹1,999</span>
            ...
            <Link
              ...
              onClick={() => {
                // Track CTA click with Meta Pixel
                trackCTAClick('Mobile Sticky CTA', 'Mobile Sticky', 1999, 'INR', 'India');
                setHasClickedCTA(true);
              }}
