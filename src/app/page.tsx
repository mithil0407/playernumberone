      ...
      <section className="pt-24 md:pt-32 pb-12 md:pb-16 px-4 md:px-6 lg:px-8 relative" id="hero">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-8">
            ...
            >
              <a
                href="https://api.whatsapp.com/send/?phone=919130048899&text=Hi+ICONIK%21+I%27d+love+to+get+my+2+outfit+recommendations+for+%E2%82%B999.&type=phone_number&app_absent=0"
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => {
                  trackCTAClick('2 Outfit Recommendations for ₹99', 'Hero Section - WhatsApp');
                }}
              ...
              >
                <div className="flex items-center justify-center gap-2 md:gap-3">
                  <div className="flex-shrink-0 w-8 h-8 md:w-9 md:h-9 bg-[#25D366] rounded-full flex items-center justify-center">
                  ...
                  <div className="text-left flex-1">
                    <p className="luxury-heading text-luxury-charcoal text-sm md:text-base mb-0.5">
                      Get <span className="text-luxury-accent">2 outfit recommendations for ₹99</span>
                    </p>
                    <p className="luxury-body text-luxury-charcoal/70 text-xs">
                      Chat with our stylists on WhatsApp — no signup needed!
                    </p>
                  </div>
                  <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-luxury-accent flex-shrink-0" />
                </div>
              </a>
            </motion.div>
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <p className="luxury-body text-luxury-charcoal/80 text-base md:text-lg mb-2">
                Get <span className="text-luxury-accent font-semibold">2 outfit recommendations for ₹99</span> — directly on WhatsApp.
              </p>
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => {
                trackCTAClick('2 Outfit Recommendations for ₹99', 'Exit Intent Popup - WhatsApp');
