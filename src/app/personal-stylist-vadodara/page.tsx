...
export const metadata: Metadata = {
  ...
  description: "Online personal styling for Vadodara women. Iconik's science-backed Style Blueprint — body analysis, colour palette, and 16+ outfit recommendations for Baroda's cultural and professional lifestyle. Delivered in 48 hours.",
  ...
  openGraph: {
    title: "Personal Stylist in Vadodara — Iconik Style Blueprint",
    description: "Science-backed personal styling for Vadodara women. Blueprint delivered in 48 hours.",
