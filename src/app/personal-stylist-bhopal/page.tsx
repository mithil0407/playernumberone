...
export const metadata: Metadata = {
  ...
  description: "Online personal styling for Bhopal women. Iconik's science-backed Style Blueprint — body analysis, colour palette, and 16+ outfit recommendations for Bhopal's professional and traditional lifestyle. Delivered in 48 hours.",
  ...
  openGraph: {
    title: "Personal Stylist in Bhopal — Iconik Style Blueprint",
    description: "Science-backed personal styling for Bhopal women. Blueprint delivered in 48 hours.",
...
export default function BhopalPage() {
  return (
    <>
      ...
      <CityLandingPage
        city="Bhopal"
        cityContext="Bhopal — the City of Lakes — has a distinctive cultural identity shaped by its Nawabi heritage, its role as Madhya Pradesh's administrative capital, and a growing university and professional population. The city's women navigate a wardrobe that spans formal government and corporate professional contexts, the city's celebrated arts and cultural calendar, and traditional occasion wear rooted in Central Indian aesthetics. Iconik's Style Blueprint brings a science-backed colour and silhouette analysis to Bhopal women — so that your everyday professional wardrobe and your festive pieces are built on the same personal foundation. Delivered in 48 hours."
        testimonial={{
