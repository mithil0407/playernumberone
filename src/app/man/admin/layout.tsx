      ...
      `} style={{ background: '#0f0f0f', borderColor: '#1e1e1e' }}>
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor: '#1e1e1e' }}>
          <div className="flex items-center gap-3">
            ...
            <div className="leading-none">
              ...
              <p className="text-[10px] font-semibold tracking-[0.2em] uppercase" style={{ color: '#c9a96e' }}>Man · Admin</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-3 py-4 border-t" style={{ borderColor: '#1e1e1e' }}>
          <button
            ...
            style={{ color: '#6b5f4a' }}
            onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.color = '#ef4444'; (e.currentTarget as HTMLButtonElement).style.background = '#1a0a0a'; }}
            onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.color = '#6b5f4a'; (e.currentTarget as HTMLButtonElement).style.background = 'transparent'; }}
          >
            <LogOut size={15} />
            Sign out
          </button>
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="lg:hidden flex items-center gap-3 px-4 py-3.5 border-b" style={{ background: '#0f0f0f', borderColor: '#1e1e1e' }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold tracking-wide" style={{ color: '#f0ebe0' }}>Man Admin</span>
          </div>
          {open && (
