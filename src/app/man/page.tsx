...
const blueprintItems = [
    ...
    { icon: <CheckCircle className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#94A6AD' }} />, title: 'Reviewed by an ICONIK Stylist', desc: 'Our system generates your Blueprint from your intake, then a human ICONIK stylist reviews it before delivery — no appointment or video call required.' },
...
const faqs = [
    ...
    { question: 'How long does it take to receive my Blueprint?', answer: `Within ${BLUEPRINT_OFFER.deliveryWorkingDays} working days of completing your intake.` },
            ...
            <section className="pt-24 pb-16 px-4 md:px-6" style={{ background: 'linear-gradient(180deg, #F8F3E9 0%, #F1E9D8 100%)' }}>
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p style={{ fontSize: '15px', lineHeight: 1.8, color: '#2C2622', opacity: 0.65, maxWidth: '600px', margin: '0 auto 32px' }}>
                        ...
                        <strong style={{ fontWeight: 500, opacity: 1, color: '#2C2622' }}>full style blueprint generated by ICONIK&apos;s system and reviewed by a human stylist</strong> — built for how men actually dress.{' '}
            ...
            <section className="py-24 px-4 md:px-6 me-slate">
                <div className="max-w-3xl mx-auto text-center relative z-10">
                    <p style={{ fontSize: '17px', lineHeight: 1.85, color: '#F4EFE5', opacity: 0.75, marginBottom: '32px', maxWidth: '520px', margin: '0 auto 32px' }}>
                        Generic style advice is easy to forget. Your ICONIK Blueprint remains as a practical reference for outfits, shopping, grooming, eyewear and colour decisions.
                    </p>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            { step: '02', title: 'Automated Analysis', desc: "Our proprietary ICONIK system analyses your frame, colour profile, and facial architecture — built specifically for how men dress." },
                            { step: '03', title: 'You Receive', desc: `Your personalised Blueprint arrives within ${BLUEPRINT_OFFER.deliveryWorkingDays} working days of completing your intake. ${BLUEPRINT_OFFER.outfitFormulas} outfits, your colour palette and face architecture guide. Yours to keep.` },
                        ].map((s) => (
