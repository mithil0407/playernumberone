...
export const metadata: Metadata = {
  ...
  description: "Online personal styling for Thiruvananthapuram women. Iconik's science-backed Style Blueprint — body analysis, colour palette, and 16+ outfit recommendations for Trivandrum's professional and Kerala lifestyle. Delivered in 48 hours.",
  ...
  openGraph: {
    title: "Personal Stylist in Thiruvananthapuram — Iconik Style Blueprint",
    description: "Science-backed personal styling for Thiruvananthapuram women. Blueprint delivered in 48 hours.",
