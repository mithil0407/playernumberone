...
const BASE_PRICE = 119;   // USD 119
const ADDON_PRICE = 49;   // USD 49 — The ICONIK Edit
...
export default function GlobalCheckoutPage() {
    ...
    const processPayment = useCallback(async () => {
        ...
        try {
            const response = await fetch('/api/global-payment', {
                method: 'POST',
            ...
            const initRazorpay = () => {
                const options: RazorpayOptions = {
                    ...
                    handler: async (rzpResponse: RazorpayResponse) => {
                        trackPurchase(
                            totalAmount,
                            'ICONIK Blueprint Global',
                            ['iconik_blueprint_global'],
                            1,
                            'USD',
                            'Global Funnel',
            ...
            console.error('Global payment error:', err);
            setIsProcessing(false);
        ...
        <div className="min-h-screen bg-luxury-warm-white text-luxury-charcoal overflow-x-hidden">
            ...
            <header className="bg-luxury-warm-white/95 backdrop-blur-xl border-b border-luxury-cream py-4 px-6">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    <Link href="/global" className="luxury-body text-luxury-charcoal/60 hover:text-luxury-charcoal transition-colors text-sm">
                        ← Back
                    </Link>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-start">
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            {/* Email */}
                            <div>
                                <label htmlFor="global-email" className="block luxury-body text-luxury-charcoal/70 text-sm font-semibold mb-2">
                                    Email Address *
                                </label>
                                <input
                                    type="email"
                            ...
                            {/* Phone */}
                            <div>
                                <label htmlFor="global-phone" className="block luxury-body text-luxury-charcoal/70 text-sm font-semibold mb-2">
                        ...
                        <div className="bg-luxury-cream/40 border border-luxury-cream rounded-2xl p-6">
                            ...
                            <div className="mt-5 flex items-center gap-3 bg-luxury-warm-white rounded-xl p-4 border border-luxury-cream">
                                ...
                                <p className="luxury-body text-luxury-charcoal/60 text-xs leading-relaxed italic">
                                    &quot;The face architecture section alone was worth three times the price.&quot; — Sofia, New York
                                </p>
                            </div>
                        </div>
