...
function GlobalIntakePageInner() {
    ...
    useEffect(() => {
        trackPageView('Global Intake');
        const urlEmail = searchParams.get('email') || '';
        const urlPhone = searchParams.get('phone') || '';
        const lsEmail = typeof window !== 'undefined' ? localStorage.getItem('global_customerEmail') || '' : '';
        const lsPhone = typeof window !== 'undefined' ? localStorage.getItem('global_customerPhone') || '' : '';
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.error('Global intake submit error:', err);
