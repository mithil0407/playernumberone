...
function CTAButton({ className = '' }: { className?: string }) {
    return (
        <Link
            href="/global/checkout"
            onClick={() => trackCTAClick('Get My Blueprint', 'Global Landing', 119, 'USD', 'Global Funnel')}
        ...
        >
            GET MY BLUEPRINT — $119 <ArrowRight className="ml-3 h-4 w-4" />
        </Link>
    );
}
...
export default function GlobalLandingPage() {
    ...
    const heroImages = useMemo(() => [
        { src: '/transformation-1.webp', caption: 'Blueprint transformation · Amara, London' },
        { src: '/au-hero-2.webp', caption: 'Blueprint transformation · Sofia, New York' },
        { src: '/transformation-2.webp', caption: 'Blueprint transformation · Priya, Toronto' },
    ], []);
        ...
        <div className="min-h-screen bg-luxury-warm-white text-luxury-charcoal overflow-x-hidden">
                ...
                <div className="max-w-5xl mx-auto text-center">
                    <div>
                        ...
                        <p className="text-sm md:text-xl luxury-body text-luxury-charcoal/70 max-w-3xl mx-auto mb-8 leading-relaxed">
                            ICONIK analyses your facial architecture, body geometry, and colour harmony using a proprietary methodology used by professional stylists worldwide.{' '}
                            <span className="font-semibold text-luxury-accent">Personalised Blueprint. 24-hour delivery. $119.</span>
                        </p>
            ...
            <section className="py-24 px-4 md:px-6 bg-luxury-accent">
                <div className="max-w-3xl mx-auto text-center text-luxury-warm-white">
                    <p className="luxury-body text-luxury-warm-white/70 text-lg leading-relaxed mb-8">
                        An in-person personal styling session costs $500–$2,000+. They give you one day. You forget half of it. You still don&apos;t know your colours.
                    </p>
                    <div className="bg-luxury-warm-white/10 backdrop-blur-sm border border-luxury-warm-white/20 rounded-2xl p-10 mb-10">
                        ...
                        <div className="text-4xl md:text-7xl luxury-heading text-luxury-warm-white mb-3">$119</div>
                    ...
                    <Link
                        href="/global/checkout"
                        onClick={() => trackCTAClick('Get My Blueprint', 'Global Price Section', 119, 'USD', 'Global Funnel')}
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-luxury-warm-white/98 backdrop-blur-xl border-t border-luxury-cream p-3 md:hidden z-50">
                <div className="max-w-sm mx-auto">
                    <Link
                        href="/global/checkout"
                        onClick={() => trackCTAClick('Get My Blueprint', 'Global Sticky CTA', 119, 'USD', 'Global Funnel')}
