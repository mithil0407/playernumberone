...
export const metadata: Metadata = {
  ...
  description: "Online personal styling for Patna women. Iconik's science-backed Style Blueprint — body analysis, colour palette, and 20 outfit formulas for Patna's professional and Bihari lifestyle. Delivered within 5 working days after consultation.",
  ...
  openGraph: {
    title: "Personal Stylist in Patna — Iconik Style Blueprint",
    description: "Science-backed personal styling for Patna women. Blueprint delivered within 5 working days after consultation.",
