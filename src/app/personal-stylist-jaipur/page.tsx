...
export const metadata: Metadata = {
  ...
  description: "Online personal styling for Jaipur women. Iconik's science-backed Style Blueprint — body analysis, colour palette, and 20 outfit formulas for Jaipur's professional and traditional lifestyle. Delivered within 5 working days after consultation.",
  ...
  openGraph: {
    title: "Personal Stylist in Jaipur — Iconik Style Blueprint",
    description: "Science-backed personal styling for Jaipur women. Blueprint delivered within 5 working days after consultation.",
